...
var folder = 'imagenes/'; // if your photos are in a different folder specify it here
// example: var folder = 'images/'; 
// or same folder as js file then: var folder = '';
var phwidth = 589; // pictureholder width
var phheight = 200; // pictureholder height
// pictureholder DIV also has the class 'pictureholder' so you can add CSS border etc.
var photosize = 589; // width to show photos at
// Valid sizes are: 32, 48, 64, 72, 144, 160, 200, 288, 320, 400, 512, 576, 640, 720, 800
var seconds = 7; // switch photos n seconds
...
var caption_height = 0; // How many pixels high for caption box if on
...
var trans = "crossfade"; // default transition between photos
...
var flicker_time = 400; // ms between photo operations
var opacity_time = 80; // ms between opacity
...
function loadpics()
{
	...
	for (i = 0; i < pic_array.length; i++)
	{
		...
		//document.write("<IMG SRC='../../js/%22%2Bpictures%5Bi%5D.photosrc%2B%22'>;");
	}
...
function changepic()
{
	...
	document.write('
<div id="pictureholder" class="pictureholder" onclick="change_url();"'+ '+'+// 7/26/10
		/26/10/26/10' style="width: '+phwidth+'px; height: '+phheight+'px; overflow: hidden; position: relative;">'); 
  // Close the pictureholder DIV document.write('</div>
');
	...
	document.write('<div id="captionholder" class="captionholder"'+
		...
		' margin-top: 0px; padding: 0px; text-align: center;"></div>');
